...
lassocoef, display(coef, standardized)
matrix sys_df = r(coef)

// Put into excel
putexcel set group_2.xlsx, sheet(dt_df) modify
putexcel B1 = "dt_coef"
putexcel B2 = matrix(sys_dt)
putexcel C1 = "dpylr_coef"
putexcel C2 = matrix(sys_df)
